...
paste! {
    generate_napi_methods! {
        "shutterHandle",
        get_all_shutter_entity_list(model_id: String) -> Vec<ShutterListItem> => get_all_model_shutter_entity_list,
        get_shutter_entity_by_id(
            id: String,
            model_id: String ) -> Option<FullShutterModel> => get_model_shutter_entity_by_id,
        get_model_shutter_entity_by_index_num_model_id_only_api(
            index_num: i32,
            model_id: String) -> Option<FullShutterModel> => get_model_shutter_entity_by_index_num_model_id_only,
        insert_shutter_entity_only(data: FullShutterModel) -> () => insert_model_shutter_entity_only,
        update_shutter_entity_name_by_id_and_model_id_only(id: String,
        name: String,
        model_id: String) -> bool => update_model_shutter_entity_name_by_id_and_model_id_only,
    }
}
...
paste! {
    generate_napi_i32_methods! {
        "shutterHandle",
        insert_shutter_entity(data: FullShutterModel, model_id: String) -> i32 => insert_model_shutter_entity,
    }
}
...
paste! {
    generate_napi_u32_methods! {
        "shutterHandle",
        update_shutter_entity_by_id_only(
            index_num: i32,
            objects: String,
            sysvars: String,
            status: String,
            model_id: String ) -> u32 => update_model_shutter_entity_by_id_only,
        delete_shutter_entity(id: String, model_id: String) -> u32 => delete_model_shutter_entity
    }
}
