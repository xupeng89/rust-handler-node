...
/// 二元交互参数信息表， 该信息表主要用于存储二元交互参数数据，具体表结构是由二元交互参数方法表去定义 -PR
#[derive(Clone, Debug, PartialEq, Eq, DeriveEntityModel, Serialize, Deserialize)]
#[sea_orm(
    table_name = "pp_binary_pr_entity",
...
pub struct Model {
    ...
    /// 参数
    #[sea_orm(column_name = "kaij", default = "0")] // 改为小写列名
    pub kaij: String,

    /// 参数
    #[sea_orm(column_name = "kbij", default = "0")] // 改为小写列名
    pub kbij: String,

    /// 参数
    #[sea_orm(column_name = "kcij", default = "0")] // 改为小写列名
    pub kcij: String,
