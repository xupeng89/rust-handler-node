...
export declare namespace confUnit {
  ...
  /** 根据 type_num 列表查询点位信息 (返回 JSON 字符串) */
  export function getAllUnitItemApi(): Promise<Array<ConfUnitItemDto>>
  /** 根据 type_num 列表查询点位信息 (返回 JSON 字符串) */
  export function getAllUnitItemCategoryApi(secondCode: string): Promise<Array<ConfUnitItemCategoryDto>>
  /** 根据 type_num 列表查询点位信息 (返回 JSON 字符串) */
  export function getAllUnitSecondCategoryApi(firstCode: string): Promise<Array<ConfUnitSecondCategoryDto>>
  /** 根据 type_num 列表查询点位信息 (返回 JSON 字符串) */
